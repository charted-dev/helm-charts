# 🐻‍❄️🪻 Helm Chart for `charted-emails`

This is the Helm Chart to install [charted-emails](https://github.com/charted-dev/emails) on Kubernetes with Helm.
...
$ helm install emails charted/emails --namespace charted --create-namespace
```
...
| `image.image`      | Image name.                                                                                                     | `charted/emails`    |
