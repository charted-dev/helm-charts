# 🐻‍❄️🪻 Helm Chart for `charted-server`

This is the Helm Chart to install [charted-server](https://github.com/charted-dev/charted) on Kubernetes with Helm.
...
$ helm install emails charted/server --namespace charted --create-namespace
```
...
| `image.image`      | Image name.                                                                                                     | `charted/server`    |
